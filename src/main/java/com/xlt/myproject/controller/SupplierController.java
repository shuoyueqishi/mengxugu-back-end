...
public class SupplierController {
    ...
    public SupplierResponse getMemberPageList(@Param("supplier") Supplier supplier, @PathVariable("pageSize")int pageSize, @PathVariable("currentPage") int currentPage) {
        Page page = new Page();
